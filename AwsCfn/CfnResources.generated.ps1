...
#>
  ...
  param(
    ...
    [string]$AuthorizerId, # description required resource-ref-type type 
...
#>
  ...
  param(
    ...
    [string]$DeploymentId, # description required resource-ref-type type 
...
function Add-CfnCodeBuild_ProjectResource {
<#
.SYNOPSIS
...
The alias or Amazon Resource Name (ARN) of the AWS Key Management Service (AWS KMS) customer master key (CMK) that AWS CodeBuild uses to encrypt the build output.
...
http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html
.LINK
http://docs.aws.amazon.com/search/doc-search.html?searchPath=documentation&searchQuery=AWS::CodeBuild::Project
#>
  ...
  param(
    ...
    [System.Collections.IDictionary]$Artifacts, # description properties required type 

    [string]$Description, # description required type 

    [string]$EncryptionKey, # description required resource-ref-type type 
    ...
    [System.Collections.IDictionary]$Source, # description properties required type 

    [System.Collections.IDictionary]$Tags, # array-type description properties required type 

    [int]$TimeoutInMinutes, # description required type 
...
,
  ...
  $r = [ordered]@{ Type = "AWS::CodeBuild::Project" }
  $rProperties = [ordered]@{}

    ## Resource Properties
  if ($PSBoundParameters.ContainsKey('Artifacts')) {
    $rProperties.Artifacts = $Artifacts
  }
  if ($PSBoundParameters.ContainsKey('Description')) {
    $rProperties.Description = $Description
  }
  if ($PSBoundParameters.ContainsKey('EncryptionKey')) {
    $rProperties.EncryptionKey = $EncryptionKey
  }
...
Set-Alias -Name Res-CodeBuild-Project -Value Add-CfnCodeBuild_ProjectResource
...
The number of IPv6 addresses to associate with the instance's primary network interface.
.PARAMETER Ipv6Addresses
One or more specific IPv6 addresses from the IPv6 CIDR block range of your subnet to associate with the instance's primary network interface.
.PARAMETER KernelId
The kernel ID
.PARAMETER KeyName
Provides the name of the EC2 key pair.
...
#>
  ...
  param(
    ...
    [int]$Ipv6AddressCount, # description required type 

    [System.Collections.IDictionary[]]$Ipv6Addresses, #[array][System.Collections.IDictionary] array-type description properties required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('Ipv6AddressCount')) {
    $rProperties.Ipv6AddressCount = $Ipv6AddressCount
  }
  if ($PSBoundParameters.ContainsKey('Ipv6Addresses')) {
    $rProperties.Ipv6Addresses = $Ipv6Addresses
  }
  if ($PSBoundParameters.ContainsKey('KernelId')) {
    $rProperties.KernelId = $KernelId
  }
...
#>
  ...
  param(
    ...
    [string]$Ipv6CidrBlock, # description required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('Ipv6CidrBlock')) {
    $rProperties.Ipv6CidrBlock = $Ipv6CidrBlock
  }
...
#>
  ...
  param(
    ...
    [string]$DestinationIpv6CidrBlock, # description required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('DestinationIpv6CidrBlock')) {
    $rProperties.DestinationIpv6CidrBlock = $DestinationIpv6CidrBlock
  }
...
#>
  ...
  param(
    ...
    [string]$CidrIpv6, # description required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('CidrIpv6')) {
    $rProperties.CidrIpv6 = $CidrIpv6
  }
...
function Add-CfnEC2_SubnetCidrBlockResource {
<#
.SYNOPSIS
...
http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html
.LINK
http://docs.aws.amazon.com/search/doc-search.html?searchPath=documentation&searchQuery=AWS::EC2::SubnetCidrBlock
#>
...
,
  ...
  $r = [ordered]@{ Type = "AWS::EC2::SubnetCidrBlock" }
  $rProperties = [ordered]@{}
...
Set-Alias -Name Res-EC2-SubnetCidrBlock -Value Add-CfnEC2_SubnetCidrBlockResource
...
function Add-CfnEC2_VPCCidrBlockResource {
<#
.SYNOPSIS
The AWS::EC2::VPCCidrBlock resource associates a single Amazon-provided IPv6 CIDR block with an Amazon VPC VPC.
.PARAMETER AmazonProvidedIpv6CidrBlock
Whether to request an Amazon-provided IPv6 CIDR block with a /56 prefix length for the VPC.
.PARAMETER VpcId
...
http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html
.LINK
http://docs.aws.amazon.com/search/doc-search.html?searchPath=documentation&searchQuery=AWS::EC2::VPCCidrBlock
#>
  ...
  param(
    ...
    [bool]$AmazonProvidedIpv6CidrBlock, # description required type 
...
,
  ...
  $r = [ordered]@{ Type = "AWS::EC2::VPCCidrBlock" }
  $rProperties = [ordered]@{}

    ## Resource Properties
  if ($PSBoundParameters.ContainsKey('AmazonProvidedIpv6CidrBlock')) {
    $rProperties.AmazonProvidedIpv6CidrBlock = $AmazonProvidedIpv6CidrBlock
  }
  if ($PSBoundParameters.ContainsKey('VpcId')) {
    $rProperties.VpcId = $VpcId
  }
...
Set-Alias -Name Res-EC2-VPCCidrBlock -Value Add-CfnEC2_VPCCidrBlockResource
...
#>
  ...
  param(
    ...
    [ValidateSet('*','bridge','host','none')]
    [string]$NetworkMode, # allowed-values description required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('NetworkMode')) {
    $rProperties.NetworkMode = $NetworkMode
  }
...
#>
  ...
  param(
    ...
    [string]$LogGroupName, # description required type 
...
#>
  ...
  param(
    ...
    [System.Collections.IDictionary[]]$DataSources, #[array][System.Collections.IDictionary] array-type description properties required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('DataSources')) {
    $rProperties.DataSources = $DataSources
  }
  if ($PSBoundParameters.ContainsKey('Description')) {
    $rProperties.Description = $Description
  }
...
The version of the AWS OpsWorks agent that AWS OpsWorks installs on each instance.
.PARAMETER AmiId
...
For scaling instances, the type of scaling.
.PARAMETER AvailabilityZone
...
#>
  ...
  param(
    ...
    [ValidateSet('*','load','timer')]
    [string]$AutoScalingType, # allowed-values description required type 
    ...
    [string[]]$ElasticIps, #[array][string] array-type description required type 

    [string]$Hostname, # description required type 
    ...
    [ValidateSet('*','ebs','instance-store')]
    [string]$RootDeviceType, # allowed-values description required type 
    ...
    [ValidateSet('*','dedicated','default','host')]
    [string]$Tenancy, # allowed-values description required type 

    [System.Collections.IDictionary]$TimeBasedAutoScaling, # description properties required type 

    [ValidateSet('*','paravirtual','hvm')]
    [string]$VirtualizationType, # allowed-values description required type 

    [string[]]$Volumes, #[array][string] array-type description required resource-ref-type type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('AutoScalingType')) {
    $rProperties.AutoScalingType = $AutoScalingType
  }
  if ($PSBoundParameters.ContainsKey('AvailabilityZone')) {
    $rProperties.AvailabilityZone = $AvailabilityZone
  }
  ...
  if ($PSBoundParameters.ContainsKey('ElasticIps')) {
    $rProperties.ElasticIps = $ElasticIps
  }
  if ($PSBoundParameters.ContainsKey('Hostname')) {
    $rProperties.Hostname = $Hostname
  }
  ...
  if ($PSBoundParameters.ContainsKey('VirtualizationType')) {
    $rProperties.VirtualizationType = $VirtualizationType
  }
  if ($PSBoundParameters.ContainsKey('Volumes')) {
    $rProperties.Volumes = $Volumes
  }
...
A custom stack configuration and deployment attributes that AWS OpsWorks installs on the layer's instances.
...
The Amazon Resource Name (ARN) of the Amazon EC2 Container Service (Amazon ECS) cluster to register with the AWS OpsWorks stack.
.PARAMETER ElasticIps
...
#>
  ...
  param(
    ...
    [string[]]$CloneAppIds, #[array][string] array-type description required type 

    [bool]$ClonePermissions, # description required type 
    ...
    [string]$EcsClusterArn, # description required resource-ref-type type 

    [System.Collections.IDictionary[]]$ElasticIps, #[array][System.Collections.IDictionary] array-type description properties required type 

    [string]$HostnameTheme, # description required type 

    [string]$Name, # description required type 

    [System.Collections.IDictionary[]]$RdsDbInstances, #[array][System.Collections.IDictionary] array-type description properties required type 

    [string]$ServiceRoleArn, # description required resource-ref-type type 

    [string]$SourceStackId, # description required resource-ref-type type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('CloneAppIds')) {
    $rProperties.CloneAppIds = $CloneAppIds
  }
  if ($PSBoundParameters.ContainsKey('ClonePermissions')) {
    $rProperties.ClonePermissions = $ClonePermissions
  }
  ...
  if ($PSBoundParameters.ContainsKey('EcsClusterArn')) {
    $rProperties.EcsClusterArn = $EcsClusterArn
  }
  if ($PSBoundParameters.ContainsKey('ElasticIps')) {
    $rProperties.ElasticIps = $ElasticIps
  }
  ...
  if ($PSBoundParameters.ContainsKey('RdsDbInstances')) {
    $rProperties.RdsDbInstances = $RdsDbInstances
  }
  if ($PSBoundParameters.ContainsKey('ServiceRoleArn')) {
    $rProperties.ServiceRoleArn = $ServiceRoleArn
  }
  if ($PSBoundParameters.ContainsKey('SourceStackId')) {
    $rProperties.SourceStackId = $SourceStackId
  }
...
function Add-CfnOpsWorks_UserProfileResource {
<#
.SYNOPSIS
The AWS::OpsWorks::UserProfile configures SSH access for users who require access to instances in an AWS OpsWorks stack.
.PARAMETER AllowSelfManagement
Indicates whether users can use the AWS OpsWorks My Settings page to specify their own SSH public key.
...
http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html
.LINK
http://docs.aws.amazon.com/search/doc-search.html?searchPath=documentation&searchQuery=AWS::OpsWorks::UserProfile
#>
  ...
  param(
    ...
    [bool]$AllowSelfManagement, # description required type 

    [string]$IamUserArn, # description required resource-ref-type type 

    [string]$SshPublicKey, # description required type 
...
,
  ...
  $r = [ordered]@{ Type = "AWS::OpsWorks::UserProfile" }
  $rProperties = [ordered]@{}

    ## Resource Properties
  if ($PSBoundParameters.ContainsKey('AllowSelfManagement')) {
    $rProperties.AllowSelfManagement = $AllowSelfManagement
  }
  if ($PSBoundParameters.ContainsKey('IamUserArn')) {
    $rProperties.IamUserArn = $IamUserArn
  }
  if ($PSBoundParameters.ContainsKey('SshPublicKey')) {
    $rProperties.SshPublicKey = $SshPublicKey
  }
  ## Resource Attributes
  if ($DeletionPolicy) {
    $r.DeletionPolicy = $DeletionPolicy
...
Set-Alias -Name Res-OpsWorks-UserProfile -Value Add-CfnOpsWorks_UserProfileResource

function Add-CfnOpsWorks_VolumeResource {
<#
.SYNOPSIS
...
http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html
.LINK
http://docs.aws.amazon.com/search/doc-search.html?searchPath=documentation&searchQuery=AWS::OpsWorks::Volume
#>
  ...
  param(
    ...
    [string]$Ec2VolumeId, # description required resource-ref-type type 

    [string]$MountPoint, # description required type 
...
,
  ...
  $r = [ordered]@{ Type = "AWS::OpsWorks::Volume" }
  $rProperties = [ordered]@{}

    ## Resource Properties
  if ($PSBoundParameters.ContainsKey('Ec2VolumeId')) {
    $rProperties.Ec2VolumeId = $Ec2VolumeId
  }
  if ($PSBoundParameters.ContainsKey('MountPoint')) {
    $rProperties.MountPoint = $MountPoint
  }
  if ($PSBoundParameters.ContainsKey('Name')) {
    $rProperties.Name = $Name
  }
...
Set-Alias -Name Res-OpsWorks-Volume -Value Add-CfnOpsWorks_VolumeResource
...
#>
  ...
  param(
    ...
    [bool]$CopyTagsToSnapshot, # description required type 
    ...
    [string]$Timezone, # description required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('CopyTagsToSnapshot')) {
    $rProperties.CopyTagsToSnapshot = $CopyTagsToSnapshot
  }
...
function Add-CfnSSM_AssociationResource {
<#
.SYNOPSIS
The AWS::SSM::Association resource associates an Amazon EC2 Simple Systems Manager (SSM) document with EC2 instances that contain a configuration agent to process the document.
...
.PARAMETER ScheduleExpression
A Cron expression that specifies when the association is applied to the target.
.PARAMETER Targets
...
http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html
.LINK
http://docs.aws.amazon.com/search/doc-search.html?searchPath=documentation&searchQuery=AWS::SSM::Association
#>
  ...
  param(
    ...
    [string]$DocumentVersion, # description required type 
...
,
  ...
  $r = [ordered]@{ Type = "AWS::SSM::Association" }
  $rProperties = [ordered]@{}

    ## Resource Properties
  if ($PSBoundParameters.ContainsKey('DocumentVersion')) {
    $rProperties.DocumentVersion = $DocumentVersion
  }
  if ($PSBoundParameters.ContainsKey('InstanceId')) {
    $rProperties.InstanceId = $InstanceId
  }
...
Set-Alias -Name Res-SSM-Association -Value Add-CfnSSM_AssociationResource
...
The type of document to create that relates to the purpose of your document.
.PARAMETER DeletionPolicy
With the DeletionPolicy attribute you can preserve or (in some cases) backup a resource when its stack is deleted. You specify a DeletionPolicy attribute for each resource that you want to control. If a resource has no DeletionPolicy attribute, AWS CloudFormation deletes the resource by default.
...
#>
  ...
  param(
    ...
    [ValidateSet('*','Command','Policy','Automation')]
    [string]$DocumentType, # allowed-values description required type 
...
,
  ...
  if ($PSBoundParameters.ContainsKey('DocumentType')) {
    $rProperties.DocumentType = $DocumentType
  }
  ## Resource Attributes
  if ($DeletionPolicy) {
    $r.DeletionPolicy = $DeletionPolicy
